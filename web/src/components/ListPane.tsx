          ...
          <div className="divide-y divide-neutral-700/30">
            {list.items.map((item) => (
              <div
                ...
                className={`p-4 hover:bg-neutral-700 transition cursor-pointer border-l-2 ${
                  item.is_checked 
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    className="w-5 h-5 text-red-600 bg-neutral-700 border-neutral-600 rounded focus:ring-red-500"
                  />
