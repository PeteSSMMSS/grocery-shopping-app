  ...
  return (
    <div className="h-screen flex flex-col bg-[#1f1f1f]">
      <header className="bg-[#282828] shadow-lg border-b border-neutral-800">
        <div className="px-4 py-3 md:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Mobile/Tablet: Only "Erledigt" button bis <xl */}
      ...
      <button
        ...
        className="xl:hidden fixed bottom-6 right-6 w-16 h-16 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded-full shadow-2xl flex items-center justify-center z-50 touch-manipulation"
